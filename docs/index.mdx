...
Raven is a programmable event engine for EVM chains. It turns source-specific
blockchain data into normalized events, then delivers those events to reusable
plugins.
...
- Poll any standard Ethereum-compatible HTTP JSON-RPC endpoint with Alloy.
