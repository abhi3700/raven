...
<CardGroup cols={2}>
  <Card title="Run Raven" icon="rocket" href="/docs/getting-started/quickstart">
    Stream blocks from any standard EVM JSON-RPC endpoint with the Alloy source.
  </Card>
...
- Ingest from EVM-compatible HTTP(S) polling or WS(S) subscriptions with Alloy.
...
<Note>
Raven is early-stage software. Reth ExEx support, reorg detection, and dynamic
