...
- [ ] Package the adapter in a separate, version-pinned Raven-enabled Reth
  binary that installs the ExEx and launches the node.
...
| Reth version support policy | Determines how the Raven-enabled node binary is released and upgraded |
